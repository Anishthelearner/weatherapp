const apiurl = "http://localhost/prototype3/data.php";
...
async function checkweather(){
    ...
    // Assume 'weatherData' is your JSON array received from the PHP script
...
var data = weatherdata.filter(entry => entry.Day_Of_Week === currentDayOfWeek);
var Sundaydata = weatherdata.filter(entry => entry.Day_Of_Week === 'Sunday');
var Mondaydata = weatherdata.filter(entry => entry.Day_Of_Week === 'Monday');
var Tuesdaydata = weatherdata.filter(entry => entry.Day_Of_Week === 'Tuesday');
var Wednesdaydata = weatherdata.filter(entry => entry.Day_Of_Week === 'Wednesday');
var Thursdaydata = weatherdata.filter(entry => entry.Day_Of_Week === 'Thursday');
var Fridaydata = weatherdata.filter(entry => entry.Day_Of_Week === 'Friday');
var Saturdaydata = weatherdata.filter(entry => entry.Day_Of_Week === 'Saturday');
...
// document.querySelector('.day1 #wtemp').innerHTML = 
// document.querySelector('.day1 #wpress').innerHTML = Sundaydata[0].Weather_Description; 
...
//     const weatherDescription = data[0].Weather_Description.toLowerCase();
//     const imageUrl = imageMapping[weatherDescription];
//     img.src = `${imageUrl}`; // Update the path accordingly

//     const sunweatherDescription = Sundaydata[0].Weather_Description.toLowerCase();
//     const sunimageUrl = imageMapping[sunweatherDescription];
//     sunimg.src = `${sunimageUrl}`;

//     const monweatherDescription = Mondaydata[0].Weather_Description.toLowerCase();
//     const monimageUrl = imageMapping[monweatherDescription];
//     monimg.src = `${monimageUrl}`;

//     const tueweatherDescription = Tuesdaydata[0].Weather_Description.toLowerCase();
//     const tueimageUrl = imageMapping[tueweatherDescription];
//     tueimg.src = `${tueimageUrl}`;

//     const wedweatherDescription = Wednesdaydata[0].Weather_Description.toLowerCase();
//     const wedimageUrl = imageMapping[wedweatherDescription];
//     wedimg.src = `${wedimageUrl}`;

//     const thuweatherDescription = Thursdaydata[0].Weather_Description.toLowerCase();
//     const thuimageUrl = imageMapping[thuweatherDescription];
//     thuimg.src = `${thuimageUrl}`;

//     const friweatherDescription = Fridaydata[0].Weather_Description.toLowerCase();
//     const friimageUrl = imageMapping[friweatherDescription];
//     friimg.src = `${friimageUrl}`;

//     const satweatherDescription = Saturdaydata[0].Weather_Description.toLowerCase();
//     const satimageUrl = imageMapping[satweatherDescription];
//     satimg.src = `${satimageUrl}`;
...
checkweather();
    ...
    // Function to handle the "Enter" key press in the search box
    ...
    // // Check the content of the message and show the div accordingly
    // if (message && message.toLowerCase().includes('not found')) {
    //     const cityNotFoundDiv = document.querySelector('.not-found');
    //     cityNotFoundDiv.style.display = 'block';
    // }
